...
const SVC_URL = "https://appadaycreator.com/menstrual-cycle-tracker/";
const SVC_NAME = "生理周期トラッカー";

test.describe("生理周期トラッカー - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("menstrual-cycle-tracker");
